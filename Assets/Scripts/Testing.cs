...
public class Testing : MonoBehaviour
{
    ...
    private int CurrentIndex
    {
        ...
        set
        {
            ...
            {
                currentIndex = Mathf.Clamp(value, 0, 20);
                GenerateLevel(currentIndex);
            } else
            {
                currentIndex = Mathf.Clamp(value, 0, seeds.Length - 1);
                levelManager.LoadLevel(new LevelManager.Seed(seeds[currentIndex]));
            }
        }
    }
    ...
    private string[] seeds = new string[]{
        "1/1/1",
        "3/1/1-5-3",
        "3/3/1-5-4-4-7-7-5-5-3",
        "4/4/1-5-5-4--6--4--6-7-2-3-7-7-7",
        "5/5/5-5-5-5-4-6-1---4-6----4-6----4-6-7-7-7-7",
        "14/11/4-7-7-7-0-0-5-5-5-5-3-0-0-0-4-0-0-6-0-0-6-0-0-0-0-0-0-0-4-0-0-6-7-7-2-7-7-7-2-5-4-0-4-0-0-0-6-7-7-2-7-7-6-0-4-0-4-0-0-0-0-0-0-6-0-6-6-0-4-0-4-0-0-5-5-5-5-2-5-6-6-0-4-0-4-7-7-2-0-0-5-5-5-5-6-0-4-0-4-0-0-6-0-0-6-0-0-4-7-7-2-4-4-0-0-6-0-0-2-5-5-5-5-4-0-4-4-0-0-6-0-0-6-0-0-0-0-4-0-4-1-5-5-2-5-5-2-7-7-7-7-7-7-7",
    ...
    {
        Debug.Log(size);
        string seed = $"{size}/{size}/1-";
        for(int i = 1; i < size * size; i++)
            seed += "2-";
        levelManager.LoadLevel(new LevelManager.Seed(seed.Trim('-')));
    }
}